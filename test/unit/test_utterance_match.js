...
var experiment = function() {
	...
	mismatches.forEach((mistake) => {
		...
		targetMap = getTargets(ScratchRegex.getGeneralTriggers())
		...
		targetMap = getTargets(ScratchRegex.getEditProjectTriggers())
		for (var triggerType in targetMap) {
			targetMap[triggerType].forEach((target) => {
			printDistances(target, utterance)
			});
...
var generateGeneralTriggerTest = (mistake) => {
	writeTest(mistake, ScratchRegex.getGeneralTriggers())
}

var generateEditProjectTriggerTest = (mistake) => {
	writeTest(mistake, ScratchRegex.getEditProjectTriggers())
}
